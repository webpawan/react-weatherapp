...
const InputData = ({search,CurrentData,MyData}) => {
...
<select placeholder='day' name="forecast" className='mx-2' value={count} onChange={e=>setcount(e.target.value)}> 
{
...
{/* {toggle && <Forcast Data={Data[count].hour} />} */}
<button className='my-3 btn btn-outline-danger mybtn text-white' onClick={()=>setToggle(!toggle)}>{toggle ? "show less" : "show more"}</button>
    </>
  )
}
